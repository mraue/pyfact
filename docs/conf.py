...
latex_documents = [
  ('index', 'pyfact.tex', u'pyfact Documentation',
   u'Martin Raue', 'manual'),
]
...
man_pages = [
    ('index', 'pyfact', u'pyfact Documentation',
     [u'Martin Raue'], 1)
]
...
texinfo_documents = [
  ('index', 'pyfact', u'pyfact Documentation',
   u'Martin Raue', 'pyfact', 'One line description of project.',
   'Miscellaneous'),
]
